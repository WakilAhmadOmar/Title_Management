...
import { API_LOGIN, APP_SIGNUP, APP_WALLET } from "../assets/routes";
  ...
  return (
    <div className="max_width_app grid items-center h-screen ">
      ...
      <div className="max-w-md w-[30rem] mx-auto h-fit p-6 border border-gray-200 rounded-lg">
        ...
        <p className="text-center font-normal text-md dark:text-white">
        ...
        <div className="row grid mt-5">
          <p className="font-normal text-sm text-center dark:text-white">
            Forgot your password?
          </p>
        </div>
        <div className="grid grid-cols-[auto_auto_auto] items-center my-5">
